      ...
      <div className="container">
        <div className="booking-card">
          <div className="booking-tabs" role="tablist" aria-label="Booking type">
            <button
              className={`booking-tab ${activeTab === 'flights' ? 'active' : ''}`}
              role="tab"
            ...
            >
              <span className="tab-icon" aria-hidden>
                {/* airplane icon */}
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M21 16v-2l-8-5V3.5a1.5 1.5 0 0 0-3 0V9L2 14v2l8-2.5V19l-2 1.5V22l3-1 3 1v-1.5L13 19v-5.5l8 2.5Z"/></svg>
              </span>
              Flights
            </button>
            <button
              className={`booking-tab ${activeTab === 'stays' ? 'active' : ''}`}
              role="tab"
            ...
            >
              <span className="tab-icon" aria-hidden>
                {/* bed icon */}
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M4 7a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3v3h4a2 2 0 0 1 2 2v6h-2v-3H4v3H2v-8a3 3 0 0 1 3-3h-1V7Z"/></svg>
              </span>
              Stays
            </button>
          </div>
